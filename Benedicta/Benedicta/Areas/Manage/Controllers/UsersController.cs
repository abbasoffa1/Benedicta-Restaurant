...
namespace Benedicta.Areas.Manage.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Phone,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Phone,Password")] User user)
        {
            if (ModelState.IsValid)
            {
